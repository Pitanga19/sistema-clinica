...
from app.modules.people.schemas import PeopleCreate, PeopleOut, PeopleUpdate, PeopleFilter
...
@router.post('/', response_model=PeopleOut, status_code=201)
...
@router.get('/{person_id}', response_model=PeopleOut, status_code=200)
...
@router.get('/', response_model=List[PeopleOut], status_code=200)
...
@router.patch('/{person_id}', response_model=PeopleOut, status_code=200)
